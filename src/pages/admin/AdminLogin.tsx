        ...
        <div className="min-h-screen flex items-center justify-center bg-[#FAFAFA] p-4">
            <Card className="max-w-md w-full">
                <CardHeader className="space-y-1">
                    ...
                    <CardTitle className="text-2xl text-center font-bold">{t('login.adminWelcome')}</CardTitle>
                    <p className="text-center text-gray-600">{t('login.adminCredentials')}</p>
                </CardHeader>
                ...
                <CardFooter className="flex justify-center">
                    <p className="text-xs text-gray-500">
                        {t('login.userLoginHint')} <Link to="/login" className="text-covrzy-purple hover:underline">{t('login.userLogin')}</Link>
                    </p>
                </CardFooter>
            </Card>
        </div>
